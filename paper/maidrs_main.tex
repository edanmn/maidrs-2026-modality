...
\begin{enumerate}
    \item \textbf{A modality that looks uninformative is recoverable.} Measured
    ...
    \item \textbf{One half of the diagnosis is a general hazard, the other is
    ...
    \item \textbf{The negative control holds against the published
    ...
    \item \textbf{Correctly specified, the second modality is still redundant
...
\textbf{Protocol.} Repeated Monte-Carlo drug-disjoint subsampling: for each
...
\textbf{Implication.} Model-class mismatch is a hazard for this modality in both
